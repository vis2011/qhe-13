...
var pl1, plimg1, pl2, clueimg1, pl3, ground, groundImage , pl4 , portal;
var ddr;
var dd_running , dr , d_running , ideal ,wallimg ,wall , clueobject1;
...
var b1img ,b2img ,ddr2 ,clue2img, ddr2img, b3img, b4img ,b5img ,b6img ,b7img,b8img ,b9img ,b10img , b11img , gameoverbg , restart ,gc1img , gc2img , gc3img ,gc4img ,gc5img;
...
clueobject1.size = 0.099;

clueobject1.velocityY=2; 
...
clueobjGroup1.add(clueobject1)
    ...
    if(ddr2.isTouching(clueobjGroup1)){
